"""
Project URL configuration. Exposes /api endpoints and Swagger docs.
"""
...
urlpatterns = [
    ...
    path('health/', health, name='root-health'),
...
schema_view = get_schema_view(
   openapi.Info(
      title="Nutrition Connect API",
      default_version='v1',
      description="Backend API for nutrition-coach platform",
   ),
   public=True,
